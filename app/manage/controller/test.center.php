...
class action extends app
{
	public function display()
	{
        ...
        //$this->course = $this->G->make('center','plane');
       // $this->course = $this->G->make('basic','test');
       // $this->course = $this->G->make('searchScore','exam');
...
private function setCurrentBasic()
    ...
    private function ajax()
    {
        switch($this->ev->url(4))
        {
            ...
            if($sectionid)
            $data = '<option value="0">选择次知识点</option>'."\n";
            else
            $data = '<option value="0">请先选择知识点</option>'."\n";
