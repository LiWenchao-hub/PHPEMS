...
{x2;endif}
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?{x2;$_app}-app-exam-questype">题型管理</a></li>
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						修改题型
						<a class="btn btn-primary pull-right" href="index.php?edu-app-exam-questype&page={x2;$page}{x2;$u}">题型管理</a>
					</h4>
			        <form action="index.php?edu-app-exam-modifyquestype" method="post" class="form-horizontal">
						<fieldset>
