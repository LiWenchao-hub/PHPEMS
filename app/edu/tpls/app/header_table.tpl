...
<head>
	...
	<![endif]-->
	<script src="app/core/styles/bootstrap-table/jquery.min.js"></script>
	<script src="app/core/styles/js/bootstrap.min.js"></script>
	<script src="app/core/styles/js/bootstrap-datetimepicker.js"></script>
	<script src="app/core/styles/bootstrap-table/bootstrap-table.min.js"></script>
	<script src="app/core/styles/bootstrap-table/locale/bootstrap-table-zh-CN.js"></script>
