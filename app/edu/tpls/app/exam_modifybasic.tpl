...
{x2;endif}
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							<li><a href="index.php?edu-app">教务管理</a></li>
							<li><a href="index.php?edu-app-exam">考场管理</a></li>
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						修改考场
						<a class="btn btn-primary pull-right" href="index.php?edu-app-exam&page={x2;$page}{x2;$u}">考场管理</a>
					</h4>
		        	<form action="index.php?edu-app-exam-modifybasic" method="post" class="form-horizontal">
						<fieldset>
								...
								<div class="col-sm-4">
									<select class="form-control" id="basicsubjectid" name="args[basicsubjectid]" needle="needle" msg="您必须选择考试科目">
						        		<option value="">选择科目</option>
								  		...
								  		<option value="{x2;v:subject['subjectid']}"{x2;if:v:subject['subjectid'] == $basic['basicsubjectid']} selected{x2;endif}>{x2;v:subject['subjectid']} => {x2;v:subject['subject']}</option>
								  		{x2;endtree}
							  		</select>
								</div>
							</div>
