...
{x2;endif}
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?edu-app-edu-subject">科目管理</a></li>
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						修改科目
						<a class="btn btn-primary pull-right" href="index.php?edu-app-edu-subject">科目管理</a>
					</h4>
			        <form action="index.php?edu-app-edu-modifysubject" method="post" class="form-horizontal">
						<fieldset>
