...
{x2;endif}
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							<li><a href="index.php?{x2;$_app}-app">{x2;$apps[$_app]['appname']}</a></li>
							<li><a href="index.php?{x2;$_app}-app-exam-basic&page={x2;$page}{x2;$u}">考场管理</a></li>
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						考试范围
						<a class="btn btn-primary pull-right" href="index.php?edu-app-exam-basic&page={x2;$page}{x2;$u}">考场管理</a>
					</h4>
			        <form action="index.php?edu-app-exam-setexamrange" method="post" class="form-horizontal">
						<table class="table">
							<thead>
							<tr>
