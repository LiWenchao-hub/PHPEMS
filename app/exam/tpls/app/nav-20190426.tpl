	...
	<div class="row-fluid">
		<div class="main">
			...
			<div class="col-xs-2" style="padding-top:40px;margin-left: 0px;margin-bottom: 0px;">
				...
				<a class="ajax  pull-right btn btn-default " href="index.php?user-app-logout"><em class="fa fa-window-close " aria-hidden="true" style="color: rgba(49,174,211,0.71);"></em>
