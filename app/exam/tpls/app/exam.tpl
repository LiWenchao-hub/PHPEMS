	...
	<div class="row-fluid">
		<div class="main">
			...
			<!--div class="box itembox">
                ...
                <div class="alert alert-info">
					<strong>———— 线上考试注意事项： ———— </strong>
					<!--p>
					本考场开启时间 {x2;if:$data['currentbasic']['basicexam']['opentime']['start'] && $data['currentbasic']['basicexam']['opentime']['end']}{x2;date:$data['currentbasic']['basicexam']['opentime']['start'],'Y-m-d H:i:s'} - {x2;date:$data['currentbasic']['basicexam']['opentime']['end'],'Y-m-d H:i:s'}{x2;else}不限{x2;endif} ； 考试次数 {x2;if:$data['currentbasic']['basicexam']['examnumber']}{x2;$data['currentbasic']['basicexam']['examnumber']}{x2;else}不限{x2;endif} ； 抽卷规则 {x2;if:$data['currentbasic']['basicexam']['selectrule']}系统随机抽卷{x2;else}用户手选试卷{x2;endif}。
					</p-->

					<p>
					本考场开启时间 {x2;if:$data['currentbasic']['basicexam']['opentime']['start'] && $data['currentbasic']['basicexam']['opentime']['end']}{x2;date:$data['currentbasic']['basicexam']['opentime']['start'],'Y-m-d H:i:s'} - {x2;date:$data['currentbasic']['basicexam']['opentime']['end'],'Y-m-d H:i:s'}{x2;else}不限{x2;endif} ； 
					</p>

	            	<ul class="list-unstyled">
	                	<li><b>1、</b>为保证考试顺利进行，考前请确保终端设备网络连接正常；</li>
	                	<li><b>2、</b>考试进行中，为避免人为中断，严禁打开其他应用，手机终端用户请勿接听电话！</li>
	                	<li><b>3、</b>进入考场，系统即开始计时，规定时间结束后，系统将自动提交试卷，未完成试题按零分计；</li>
	                	<li><b>4、</b>因不可抗拒因素导致考试意外中断，请及时与客服联系，系统将尽快重新开通考试；</li>
	                </ul>
                </div>
