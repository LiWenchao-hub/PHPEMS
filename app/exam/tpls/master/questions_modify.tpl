					...
					<form action="index.php?exam-master-questions-modifyquestion" method="post" class="form-horizontal">
						...
						<div class="form-group">
							<label class="control-label col-sm-2">知识点：</label>
						  	<div class="col-sm-9">
						  		<textarea class="form-control" rows="6" needle="needle" min="1" msg="您最少需要选定一个知识点" 
						  					name="args[questionknowsid]" id="questionknowsid" readonly>
{x2;tree:$question['questionknowsid'],know,kid}
{x2;v:know['knowsid']}:{x2;v:know['knows']}
{x2;enter}
{x2;endtree}
						  		</textarea>
							</div>
					  		...
					  		<div class="col-sm-9 form-inline">
						  		<select class="combox form-control" target="isectionselect" refUrl="?exam-master-questions-ajax-getsectionsbysubjectid&subjectid={value}">
					        		<option value="0">选择科目</option>
							  		...
							  		<option value="{x2;v:subject['subjectid']}">{x2;v:subject['subjectid']} => {x2;v:subject['subject']}</option>
							  		{x2;endtree}
						  		</select>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
					  			<input type="button" class="btn btn-primary" value="选定" onclick="javascript:setKnowsList('questionknowsid','isectionselect','+');"/>
					  			<input type="button" class="btn btn-danger" value="清除" onclick="javascript:setKnowsList('questionknowsid','isectionselect','-');"/>
							</div>
