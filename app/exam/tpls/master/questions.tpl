						...
						<table class="table">
					        ...
					        <tr>
								...
								<td width="100" align="center">
					        		<select class="combox form-control" autocomplete="off" name="search[questionsubjectid]" class="combox form-control" target="sectionselect" refUrl="?exam-master-questions-ajax-getsectionsbysubjectid&subjectid={value}">
							...
							<table class="table table-hover table-bordered">
					            ...
					            <tbody>
							        ...
							        <tr>
										...
										<td>
											<div class="btn-group">
					                    		<a class="btn" href="index.php?exam-master-questions-modifyquestion&page={x2;$page}&questionid={x2;v:question['questionid']}{x2;$u}" title="修改"><em class="glyphicon glyphicon-edit"></em></a>
