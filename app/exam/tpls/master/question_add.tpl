				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					...
					<form action="index.php?exam-master-questions-addquestion" method="post" class="form-horizontal">
						...
						<div class="form-group">
							...
							<!--  新版  -->
							<!--div class="col-sm-9">
					  			<input type="button" class="btn btn-primary" value="选定" 
					  			onclick="javascript:setKnowsList('questionknowsid','isectionselect','+');"/>
					  			<input type="button" class="btn btn-danger" value="清除" 
					  			onclick="javascript:setKnowsList('questionknowsid','isectionselect','-');"/>
							</div-->
