			        ...
			        <form action="index.php?exam-teach-exams-modify" method="post" class="form-horizontal">
						...
						<div class="form-group questpanel panel_{x2;v:questype['questid']}">
							...
							<div class="col-sm-9 form-inline">
								...
								<span class="info">&nbsp;<a class="selfmodal btn btn-info" href="javascript:;" data-target="#modal" url="index.php?exam-teach-exams-selected&questionids={iselectquestions_{x2;v:key}}&rowsquestionids={iselectrowsquestions_{x2;v:key}}" valuefrom="iselectquestions_{x2;v:key}|iselectrowsquestions_{x2;v:key}">看题</a></span>
