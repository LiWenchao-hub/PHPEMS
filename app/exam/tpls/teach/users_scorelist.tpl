			        ...
			        <table class="table table-hover table-bordered">
			            ...
			            <tbody style="font-size:9pt">
					        ...
					        <tr{x2;if:v:exam['ehneedresit']} class="text-danger"{x2;endif}>
								...
								<td >
									<a class="btn btn-primary" href="index.php?exam-teach-users-readpaper&ehid={x2;v:exam['ehid']}" target="_blank" style="font-size:9pt">阅卷</a>&nbsp;
									{x2;if:!v:exam['ehneedresit']}
									<a class="btn btn-danger confirm" msg="设为补考后本次成绩将作废，用户可以再进行一次考试，确定要进行此操作吗？" href="index.php?exam-teach-users-setresit&ehid={x2;v:exam['ehid']}" style="font-size:9pt">补考</a>&nbsp;
									{x2;endif}
									<a class="btn btn-primary hide" href="index.php?exam-teach-users-changescore&ehid={x2;v:exam['ehid']}" target="_blank" style="font-size:9pt">纠分</a>
								</td>
					        </tr>
					        {x2;endtree}
			        	</tbody>
