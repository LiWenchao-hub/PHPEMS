					...
					<h4 class="title" style="padding:10px;">
						...
						<span class="pull-right">
							...
							<ul class="dropdown-menu">
								<li><a href="index.php?{x2;$_app}-teach-exams-autopage&page={x2;$page}{x2;$u}">题库随机组卷</a></li>
								<li><a href="index.php?{x2;$_app}-teach-exams-selfpage&page={x2;$page}{x2;$u}">题库统一组卷</a></li>
								<li><a href="index.php?{x2;$_app}-teach-exams-temppage&page={x2;$page}{x2;$u}">自主命题组卷</a></li>
							</ul>
						</span>
					</h4>
					        ...
					        <tr>
								...
								<td>
									<div class="btn-group">
			                    		...
			                    		<a class="btn" target="_blank" href="index.php?{x2;$_app}-teach-exams-preview&examid={x2;v:exam['examid']}{x2;$u}" title="查看试卷"><em class="glyphicon glyphicon-list-alt"></em></a>
			                    		{x2;endif}
			                    		{x2;if:v:exam['examtype'] == 3}
			                    		<a class="btn ajax" href="index.php?{x2;$_app}-teach-exams-outcsv&page={x2;$page}&examid={x2;v:exam['examid']}{x2;$u}" title="下载csv"><em class="glyphicon glyphicon-download-alt"></em></a>
			                    		{x2;endif}
			                    		<a class="btn" href="index.php?{x2;$_app}-teach-exams-modify&page={x2;$page}&examid={x2;v:exam['examid']}{x2;$u}" title="修改"><em class="glyphicon glyphicon-edit"></em></a>
										<a class="btn confirm" href="index.php?{x2;$_app}-teach-exams-del&page={x2;$page}&examid={x2;v:exam['examid']}{x2;$u}" title="删除"><em class="glyphicon glyphicon-remove"></em></a>
			                    	</div>
								</td>
					        </tr>
					        {x2;endtree}
