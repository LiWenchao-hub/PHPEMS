...
class course_course
{
	...
	public function getAllCourses($args = array())
	{
        $data = array(false,'coursesubject',$args,false,false,false);
    ...
    public function getAllOpenCourseByUseridAndCsid($userid,$csid)
    {
        $data = array(false,'opencourse',array(array("AND","ocuserid = :ocuserid",'ocuserid',$userid),array("AND","occourseid = :occourseid",'occourseid',$csid)));
        $sql = $this->pdosql->makeSelect($data);
        return $this->db->fetch($sql);
    }
