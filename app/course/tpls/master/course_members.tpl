			        ...
			        <form action="index.php?course-master-course-members&courseid={x2;$courseid}" method="post" class="form-inline">
						<table class="table">
							<tr>
								...
								<td style="border-top:0px;">
									<input name="search[usertruename]" class="form-control" size="25" type="text"  value="{x2;$search['usertruename']}"/>
								</td>
								<td style="border-top:0px;">
									用户名：
								</td>
								<td style="border-top:0px;">
									<input name="search[username]" class="form-control" size="25" type="text" value="{x2;$search['username']}"/>
								</td>
								<td style="border-top:0px;">
