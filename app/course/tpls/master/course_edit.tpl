...
{x2;endif}
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					...
					<form action="index.php?course-master-course-edit" method="post" class="form-horizontal">
						...
						<div class="form-group">
							<label for="contentPublish" class="control-label col-sm-2">教材名称：</label>
							<div class="col-sm-8">
								<input id="contentPublish" name="args[ClassTitle]" class="form-control" value="{x2;$course['ClassTitle']}">
							</div>
						</div>
				        <div class="form-group">
				            <label for="contentPublish" class="control-label col-sm-2">出版社：</label>
				            <div class="col-sm-8">
							    <input id="contentPublish" name="args[publish]" class="form-control" value="{x2;$course['publish']}">
					        </div>
				        </div>
						<div class="form-group">
							<label for="contentAuthor" class="control-label col-sm-2">主编：</label>
							<div class="col-sm-4">
								<input id="contentAuthor" name="args[author]" class="form-control" value="{x2;$course['author']}">
							</div>
						</div>
						<div class="form-group">
							<label for="contentPublishTime" class="control-label col-sm-2">出版时间：</label>
							<div class="col-sm-6">
								<input id="contentpublishTime" name="args[publishTime]" class="form-control" value="{x2;$course['publishTime']}">
							</div>
						</div>
						<div class="form-group">
