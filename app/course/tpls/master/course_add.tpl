				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					...
					<form action="index.php?course-master-course-add" method="post" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input id="contentPublish" name="args[ClasTitle]" class="form-control" ></input>
							</div>
						</div>
				        <div class="form-group">
				            <label for="contentPublish" class="control-label col-sm-2">出版社：</label>
				            <div class="col-sm-8">
							    <input id="contentPublish" name="args[publish]" class="form-control" ></input>
					        </div>
				        </div>
						<div class="form-group">
							<label for="contentAuthor" class="control-label col-sm-2">主编：</label>
							<div class="col-sm-4">
								<input id="contentAuthor" name="args[author]" class="form-control" ></input>
							</div>
						</div>
						<div class="form-group">
							<label for="contentPublishTime" class="control-label col-sm-2">出版时间：</label>
							<div class="col-sm-6">
								<input id="contentdescribe" name="args[publishTime]" class="form-control" ></input>
							</div>
						</div>
						<div class="form-group">
