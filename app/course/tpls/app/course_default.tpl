...
{x2;endif}
			...
			<div class="col-xs-4 pull-right" style="padding-right:0px;">
				<div class="box itembox" style="padding-top:10px;">
					<!-------------------  右边课程列表显示课程名称 ------------------>
					<h4 class="title"><span class="fa fa-eercast" aria-hidden="true" style="font-size:24pt;color: #a0d8e9"></span>&nbsp&nbsp{x2;$course['cstitle']}</h4>
					<div>
						<!-------------------  右边课程列表显示课程介绍 ------------------>
				...
				<div class="box" style="padding-top:10px;font-size:9pt;">
					<!--   标题图片   --->
					<!--div class="col-xs-3">
					...
					<div class="col-xs-12">
						<a target="datacontent" href="index.php?course-app-course&page={x2;$page}&csid={x2;$course['csid']}&contentid={x2;v:content['courseid']}" class="ajax">
							<h6 class="title" style="margin-top:0px;">
							{x2;if:$content['courseid'] == v:content['courseid']}
							<span style="color:green;"><em class="fa fa-play-circle"></em></span>
							{x2;endif}
							{x2;if:$cdata['lock'][v:content['courseid']]}
							<span style="color:red;"><em class="fa fa-lock"></em></span>
							{x2;endif}
			...
			{x2;endif}
			<!------------  888888888888888    可见留言及其个人笔记    888888888888888  ------------->
			...
			<!------------  888888888888888  可见留言及其个人笔记  888888888888888888888------------->
{x2;if:!$userhash}
		</div>
	</div>
</div>
