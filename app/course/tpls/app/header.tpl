...
<head>
	...
	<link rel="stylesheet" type="text/css" href="app/core/styles/font-awesome-4.7.0/css/font-awesome.min.css">
	<!--link rel="stylesheet" type="text/css" href="app/core/styles/bootstrap-4.1.3/css/bootstrap.css"-->
	<!--[if lt IE 9]>
