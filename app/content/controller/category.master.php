...
class action extends app
{
	...
	private function del()
	{
		...
		$contents = $this->content->getContentList(array(array("AND","contentcatid = :contentcatid",'contentcatid',$catid)),$page,$number = 20,$order = 'contentsequence DESC,contentinputtime DESC,contentid DESC');
