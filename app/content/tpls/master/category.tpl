							...
							<table class="table table-hover table-bordered">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<div class="btn-group">
												<a class="btn" href="index.php?{x2;$_app}-master-category-add&parent={x2;v:category['catid']}{x2;$u}"><em class="fa fa-plus"></em></a>
												<a class="btn" href="index.php?content-master-category&parent={x2;v:category['catid']}{x2;$u}"><em class="fa fa-list"></em></a>
												<a class="btn" href="index.php?{x2;$_app}-master-category-edit&page={x2;$page}&catid={x2;v:category['catid']}{x2;$u}"><em class="fa fa-pencil-square-o"></em></a>
												<a class="btn confirm" href="index.php?{x2;$_app}-master-category-del&catid={x2;v:category['catid']}&page={x2;$page}{x2;$u}"><em class="fa fa-recycle"></em></a>
											</div>
										</td>
									</tr>
									{x2;endtree}
