...
<div class="container-fluid box"
     style="margin:0px auto;padding-top:10px;padding-left:0px;padding-right:0px;padding-bottom:10px;overflow:visible;">
    <div class="row-fluid">
        <div class="main">
            ...
            <div class="col-xs-10" style="padding-top:30px;margin-left: 0px;margin-bottom: 0px;">
                <h1 style="color:#337AB7;margin-left: -50px;margin-bottom: 0px;">
					<span style="font-size:15pt;padding-top:100px;margin-right:0;"><a href="index.php"><img
                                    src="app/core/styles/img/logo2.png"
                                    style="height:60px;margin-top:-10px;margin-left: 0"/></a>
					</span>
...
<div class="container-fluid navbar"
     style="margin-top:0px;margin-bottom:0px;margin-left: 0px;margin-right:0px;padding-top:10px;padding-left:0px;padding-right:0px;background-color:#337AB7;">
    <div class="row-fluid">
        <div class="main">
...
<div class="container-fluid box"
     style="margin:0px auto;padding-top:10px;padding-left:0px;padding-right:0px;padding-bottom:0px;overflow:visible;background-color:#f9fce3;"">
<div class="row-fluid">
    <div class="main">
        <div class="col-xs-10" style="padding-top:30px;margin-left: 0px;margin-bottom: 0px;">
            <h1 style="color:#337AB7;margin-left: -50px;margin-bottom: 0px;">
                <a href="index.php"><img src="app/core/styles/img/logo2.png"
                                         style="height:60px;margin-top:-10px;margin-left:10px;"/></a>
            </h1>
        </div>
        <div class="col-xs-2 pull-right" style="padding-top:40px;margin-right: 0px;margin-bottom: 0px;">
            <span><a href="javascript:;" onclick="javascript:$.loginbox.show();"
                     class="btn btn-default "> 登 录 </a></span>
            <span><a href="index.php?user-app-register" class="btn btn-default "> 注 册 </a></span>
        </div>
    </div>
</div>
<div class="container-fluid navbar"
     style="margin-top:90px;margin-bottom:0px;margin-left: 0px;margin-right:0px;padding-top:10px;padding-left:0px;padding-right:0px;background-color:#337AB7;">
    <div class="row-fluid">
        <div class="main">
            <div class="col-xs-12" style="margin-left: -50px;">
                <ul class="list-unstyled list-inline">
