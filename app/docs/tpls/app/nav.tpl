					...
					<div class="input-group">
						<div class="input-group-btn">
							<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								辅助文档 <span class="caret"></span>
							</button>
							<ul class="dropdown-menu">
								<li><a href="index.php?content-app">站内新闻</a></li>
								<li><a href="index.php?course-app">提升 课程</a></li>
								<li><a href="index.php?docs-app">辅助文档</a></li>
							</ul>
						</div>
						<input type="text" style="width:380px;" class="form-control" id="keyword" placeholder="搜索文档">
					</div>
					<button type="button" class="btn btn-primary" onclick="javascript:window.location='index.php?docs-app-search&keyword='+$('#keyword').val();"> 搜 索 </button>
				</div>
			</div>
